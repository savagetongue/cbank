...
import { Env as CoreEnv, GlobalDurableObject } from './core-utils';
// Need to export GlobalDurableObject to make it available in wrangler
export { GlobalDurableObject };
// Define a comprehensive Env type that includes secrets, matching the one in user-routes.ts
// This resolves the TypeScript error when passing the app instance to userRoutes.
